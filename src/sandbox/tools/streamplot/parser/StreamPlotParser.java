...
private class Invocation {
  ...
  final private Invocation invoke() throws ParseException {
                              Invocation method = new Invocation();
    jj_consume_token(O_PAR);
    if (jj_2_6(3)) {
      if (jj_2_4(3)) {
        params1(method.arguments);
        if (jj_2_3(3)) {
  ...
  final private int imageType() throws ParseException {
    jj_consume_token(TYPE_INT_RGB);
                         {if (true) return BufferedImage.TYPE_INT_RGB;}
    throw new Error("Missing return statement in function");
  }

  final private void params1(final List<Object> L) throws ParseException {
                                             Object v;
    v = value();
                   L.add(v);
    label_2:
  ...
  final private void params2(final Map<String,Object> hash) throws ParseException {
    param2(hash);
    label_3:
    while (true) {
      if (jj_2_8(3)) {
  ...
  final private void param2(final Map<String,Object> hash) throws ParseException {
                                                    Token t;Object o;
    t = jj_consume_token(IDENTIFIER);
    jj_consume_token(ASSIGN);
    o = value();
                if(hash.containsKey(t.image)) {if (true) throw new IllegalArgumentException("duplicate key "+t.image);}
                hash.put(t.image,o);
  }

  final private Object value() throws ParseException {
    if (jj_2_9(3)) {
      imageType();
    } else if (jj_2_10(3)) {
      integer();
  ...
  final private Color color() throws ParseException {
  ...
  private boolean jj_3R_9() {
    if (jj_scan_token(TYPE_INT_RGB)) return true;
    return false;
  }
  ...
  private boolean jj_3R_12() {
    ...
    if (jj_scan_token(C_PAR)) return true;
    return false;
  }
