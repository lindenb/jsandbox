...
public static void main(String args[])  throws Exception
  ...
  final private Color rgbcolor() throws ParseException {
                          int r,g=-1,b=-1,a=255; float fr,fg=-1f,fb=-1f,fa=1.0f; Color c;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case RGB:
  ...
  final private Color hexaColor() throws ParseException {
    ...
    t = jj_consume_token(HEXA);
                   {if (true) return Color.of( Integer.valueOf(t.image.substring(1),16) );}
    throw new Error("Missing return statement in function");
  }
    ...
    t = jj_consume_token(NAMED);
            ...
            final java.util.function.Supplier<Throwable> ex = new java.util.function.Supplier<Throwable>() {
                ...
                public Throwable get() {
                    {if (true) return new RuntimeException("cannot convert "+s);}
                    }
                };
            {if (true) return NamedColors.getInstance().findByName(s).orElseThrow(ex);}
    throw new Error("Missing return statement in function");
  }
