...
abstract class BaseSwingXmlContext extends AbstractSwingXmlContext {
	...
	protected class BasicStrokeNodeHandler extends
		NodeHandler {
		...
		@Override
		protected void fillSetters(final Object instance_o,final Element root) {
			final java.awt.BasicStroke instance= java.awt.BasicStroke.class.cast(instance_o);
			
			super.fillSetters(instance,root);
			}
		}
	
	protected class ColorNodeHandler extends
		NodeHandler {
		...
		@Override
		protected void fillSetters(final Object instance_o,final Element root) {
			final java.awt.Color instance= java.awt.Color.class.cast(instance_o);
			
			super.fillSetters(instance,root);
			}
		}
	
	protected class FontNodeHandler extends
		NodeHandler {
		...
		@Override
		protected void fillSetters(final Object instance_o,final Element root) {
			final java.awt.Font instance= java.awt.Font.class.cast(instance_o);
	...
	protected class TitledBorderNodeHandler extends
		AbstractBorderNodeHandler {
		

		@Override
		public Class<?> getType()  {
			return javax.swing.border.TitledBorder.class;
			}
		

		@Override
		protected void fillSetters(final Object instance_o,final Element root) {
			final javax.swing.border.TitledBorder instance= javax.swing.border.TitledBorder.class.cast(instance_o);
			...
			
				{
					...
					final OptionalInt opt = findInt(root,"titleJustification");
					if(opt.isPresent()) instance.setTitleJustification(opt.getAsInt());
			...
			
				{
					...
					final OptionalInt opt = findInt(root,"titlePosition");
					if(opt.isPresent()) instance.setTitlePosition(opt.getAsInt());
			...
			
				{
					...
					final Optional<Object> opt = findObject(root,"titleFont",java.awt.Font.class);
					if(opt.isPresent()) instance.setTitleFont(java.awt.Font.class.cast(opt.get()));
			...
			
				{
					...
					final Optional<Object> opt = findObject(root,"titleColor",java.awt.Color.class);
					if(opt.isPresent()) instance.setTitleColor(java.awt.Color.class.cast(opt.get()));
	...
	protected class AbstractBorderNodeHandler extends
		NodeHandler {
		

		@Override
		public Class<?> getType()  {
			return javax.swing.border.AbstractBorder.class;
			}
		

		@Override
		protected void fillSetters(final Object instance_o,final Element root) {
			final javax.swing.border.AbstractBorder instance= javax.swing.border.AbstractBorder.class.cast(instance_o);
			
			super.fillSetters(instance,root);
			}
		}
	
	protected class EmptyBorderNodeHandler extends
		AbstractBorderNodeHandler {
		...
		@Override
		protected void fillSetters(final Object instance_o,final Element root) {
			final javax.swing.border.EmptyBorder instance= javax.swing.border.EmptyBorder.class.cast(instance_o);
	...
	protected void registerNodeHandlers() {
		...
		registerNodeHandler(new BasicStrokeNodeHandler());
		
		registerNodeHandler(new ColorNodeHandler());
		
		registerNodeHandler(new FontNodeHandler());
		...
		registerNodeHandler(new TitledBorderNodeHandler());
		
		registerNodeHandler(new EmptyBorderNodeHandler());
