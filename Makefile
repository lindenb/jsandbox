...
$(eval $(call compile,atommerger,sandbox.feed.AtomMerger, ${jcommander.jar}))
...
$(eval $(call compile,treemapmaker,sandbox.tools.treemap.TreeMapMaker,${jcommander.jar} ))
...
$(eval $(call compile,ig2table,sandbox.tools.ig.IgToTable,${jcommander.jar} ${apache.httpclient.jars}))
